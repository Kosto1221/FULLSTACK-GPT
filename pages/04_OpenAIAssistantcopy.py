...
functions = [
    {
        ...
        "function": {
            ...
            "description": "Use this tool to find the URLs for a query.",
            "parameters": {
                "type": "object",
                "properties": {
                    "query": {
                        "type": "string",
                        "description": "URLs for the query",
                    }
                },
                "required": ["query"],
            }
    ...
    },
    {
        ...
        "function": {
            "name": "URLReaderTool",
            "description": "Use this tool to parse contents from URLs.",
            "parameters": {
                "type": "object",
                "properties": {
                    "urls": {
                        "type": "string",
                        "description": "List of URLs provided by DuckDuckGo or Wikipedia tools."
                    }
                },
                "required": ["urls"],
            }
...
if api_key and is_valid:
    ...
    if query:
        ...
        if st.session_state['assistant_id'] is None:
            st.session_state['assistant_id'] = get_assistants(_client=openai)
        ...
        while run.status != 'completed':
            if run.required_action.type == 'submit_tool_outputs':
                ...
                run = openai.beta.threads.runs.poll(thread_id=thread.id, run_id=run.id)
